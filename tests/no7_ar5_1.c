...
extern "C" {
 ...
 void zerdiv_(real *);
 fint no7_ar5_1_auxcom_[1] = { 14 /* nlc */ };
 fint no7_ar5_1_funcom_[1161] = {
	112 /* nvar */,
	1 /* nobj */,
	269 /* ncon */,
	1042 /* nzc */,
 ...
 real no7_ar5_1_boundc_[1+224+538] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		1.7889,
		8.54,
		1.7889,
 ...
 static real no7_ar5_1_pd[14];
static real no7_ar5_1_old_x[112];
static int no7_ar5_1_xkind = -1;

 static int
no7_ar5_1_xcheck(real *x)
{
	real *x1 = no7_ar5_1_old_x, *xe = x + 112;
	errno = 0;
	if (no7_ar5_1_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
				return 0;
		--x, --x1;
 ...
 real
no7_ar5_1_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (no7_ar5_1_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
no7_ar5_1_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
  ...
  /***  constraint 269  ***/
   ...
   /*** derivatives for constraint 6 ***/
	...
	J[121] = no7_ar5_1_pd[5];
	J[97] = -1.;

   /*** derivatives for constraint 7 ***/

	J[144] = no7_ar5_1_pd[6];
	J[168] = -1.;

   /*** derivatives for constraint 8 ***/

	J[169] = no7_ar5_1_pd[7];
	J[145] = -1.;

   /*** derivatives for constraint 9 ***/

	J[192] = no7_ar5_1_pd[8];
	J[216] = -1.;

   /*** derivatives for constraint 10 ***/

	J[217] = no7_ar5_1_pd[9];
	J[193] = -1.;

   /*** derivatives for constraint 11 ***/

	J[240] = no7_ar5_1_pd[10];
	J[264] = -1.;

   /*** derivatives for constraint 12 ***/

	J[265] = no7_ar5_1_pd[11];
	J[241] = -1.;

   /*** derivatives for constraint 13 ***/

	J[288] = no7_ar5_1_pd[12];
	J[312] = -1.;

   /*** derivatives for constraint 14 ***/

	J[313] = no7_ar5_1_pd[13];
	J[289] = -1.;
