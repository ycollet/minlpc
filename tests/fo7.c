...
extern "C" {
 ...
 void zerdiv_(real *);
 fint fo7_auxcom_[1] = { 14 /* nlc */ };
 fint fo7_funcom_[977] = {
	114 /* nvar */,
	1 /* nobj */,
	211 /* ncon */,
	856 /* nzc */,
 ...
 real fo7_boundc_[1+228+422] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.,
		8.,
		2.,
 ...
 static real fo7_pd[14];
static real fo7_old_x[114];
static int fo7_xkind = -1;

 static int
fo7_xcheck(real *x)
{
	real *x1 = fo7_old_x, *xe = x + 114;
	errno = 0;
	if (fo7_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
fo7_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (fo7_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
fo7_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
