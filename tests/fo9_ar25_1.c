...
extern "C" {
 ...
 void zerdiv_(real *);
 fint fo9_ar25_1_auxcom_[1] = { 18 /* nlc */ };
 fint fo9_ar25_1_funcom_[1921] = {
	180 /* nvar */,
	1 /* nobj */,
	435 /* ncon */,
	1734 /* nzc */,
 ...
 real fo9_ar25_1_boundc_[1+360+870] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.5298,
		6.3246,
		2.5298,
 ...
 static real fo9_ar25_1_pd[18];
static real fo9_ar25_1_old_x[180];
static int fo9_ar25_1_xkind = -1;

 static int
fo9_ar25_1_xcheck(real *x)
{
	real *x1 = fo9_ar25_1_old_x, *xe = x + 180;
	errno = 0;
	if (fo9_ar25_1_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
				return 0;
		--x, --x1;
 ...
 real
fo9_ar25_1_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (fo9_ar25_1_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
fo9_ar25_1_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
  ...
  /***  constraint 435  ***/
   ...
   /*** derivatives for constraint 2 ***/
	...
	J[61] = fo9_ar25_1_pd[1];
	J[1] = -1.;

   /*** derivatives for constraint 3 ***/

	J[30] = fo9_ar25_1_pd[2];
	J[90] = -1.;

   /*** derivatives for constraint 4 ***/

	J[91] = fo9_ar25_1_pd[3];
	J[31] = -1.;

   /*** derivatives for constraint 5 ***/

	J[120] = fo9_ar25_1_pd[4];
	J[150] = -1.;

   /*** derivatives for constraint 6 ***/

	J[151] = fo9_ar25_1_pd[5];
	J[121] = -1.;

   /*** derivatives for constraint 7 ***/

	J[180] = fo9_ar25_1_pd[6];
	J[210] = -1.;

   /*** derivatives for constraint 8 ***/

	J[211] = fo9_ar25_1_pd[7];
	J[181] = -1.;

   /*** derivatives for constraint 9 ***/

	J[240] = fo9_ar25_1_pd[8];
	J[270] = -1.;

   /*** derivatives for constraint 10 ***/

	J[271] = fo9_ar25_1_pd[9];
	J[241] = -1.;

   /*** derivatives for constraint 11 ***/

	J[300] = fo9_ar25_1_pd[10];
	J[330] = -1.;

   /*** derivatives for constraint 12 ***/

	J[331] = fo9_ar25_1_pd[11];
	J[301] = -1.;

   /*** derivatives for constraint 13 ***/

	J[360] = fo9_ar25_1_pd[12];
	J[390] = -1.;

   /*** derivatives for constraint 14 ***/

	J[391] = fo9_ar25_1_pd[13];
	J[361] = -1.;

   /*** derivatives for constraint 15 ***/

	J[420] = fo9_ar25_1_pd[14];
	J[450] = -1.;

   /*** derivatives for constraint 16 ***/

	J[451] = fo9_ar25_1_pd[15];
	J[421] = -1.;

   /*** derivatives for constraint 17 ***/

	J[480] = fo9_ar25_1_pd[16];
	J[510] = -1.;

   /*** derivatives for constraint 18 ***/

	J[511] = fo9_ar25_1_pd[17];
	J[481] = -1.;
