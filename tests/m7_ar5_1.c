...
extern "C" {
 ...
 void zerdiv_(real *);
 fint m7_ar5_1_auxcom_[1] = { 14 /* nlc */ };
 fint m7_ar5_1_funcom_[1161] = {
	112 /* nvar */,
	1 /* nobj */,
	269 /* ncon */,
	1042 /* nzc */,
 ...
 real m7_ar5_1_boundc_[1+224+538] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.8,
		8.3666,
		2.,
 ...
 static real m7_ar5_1_pd[14];
static real m7_ar5_1_old_x[112];
static int m7_ar5_1_xkind = -1;

 static int
m7_ar5_1_xcheck(real *x)
{
	real *x1 = m7_ar5_1_old_x, *xe = x + 112;
	errno = 0;
	if (m7_ar5_1_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
m7_ar5_1_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (m7_ar5_1_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
m7_ar5_1_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
  ...
  /***  constraint 269  ***/
   ...
   /*** derivatives for constraint 11 ***/
	...
	J[240] = m7_ar5_1_pd[10];
	J[264] = -1.;

   /*** derivatives for constraint 12 ***/

	J[265] = m7_ar5_1_pd[11];
	J[241] = -1.;

   /*** derivatives for constraint 13 ***/

	J[288] = m7_ar5_1_pd[12];
	J[312] = -1.;

   /*** derivatives for constraint 14 ***/

	J[313] = m7_ar5_1_pd[13];
	J[289] = -1.;
