...
extern "C" {
 ...
 void zerdiv_(real *);
 fint slay05h_auxcom_[1] = { 0 /* nlc */ };
 fint slay05h_funcom_[1037] = {
	230 /* nvar */,
	1 /* nobj */,
	290 /* ncon */,
	800 /* nzc */,
 ...
 real slay05h_boundc_[1+460+580] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.5,
		27.5,
		3.5,
 ...
 static real slay05h_pd[20];
static real slay05h_old_x[230];
static int slay05h_xkind = -1;

 static int
slay05h_xcheck(real *x)
{
	real *x1 = slay05h_old_x, *xe = x + 230;
	errno = 0;
	if (slay05h_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
slay05h_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real v[2], dv[10], rv;
	fint wantfg = *needfg;
	if (slay05h_xcheck(x) && wantfg == 2)
		wantfg = 3;
  ...
  /***  objective ***/
	...
	v[0] = x[0] + -4.;
	slay05h_pd[0] = v[0] * v[0];
	slay05h_pd[1] = v[0] + v[0];
	v[0] = 150. * slay05h_pd[0];
	v[1] = x[5] + -10.;
	slay05h_pd[2] = v[1] * v[1];
	slay05h_pd[3] = v[1] + v[1];
	v[1] = 150. * slay05h_pd[2];
	v[0] += v[1];
	v[1] = x[1] + -10.;
	slay05h_pd[4] = v[1] * v[1];
	slay05h_pd[5] = v[1] + v[1];
	v[1] = 390. * slay05h_pd[4];
	v[0] += v[1];
	v[1] = x[6] + -15.;
	slay05h_pd[6] = v[1] * v[1];
	slay05h_pd[7] = v[1] + v[1];
	v[1] = 390. * slay05h_pd[6];
	v[0] += v[1];
	v[1] = x[2] + -7.;
	slay05h_pd[8] = v[1] * v[1];
	slay05h_pd[9] = v[1] + v[1];
	v[1] = 240. * slay05h_pd[8];
	v[0] += v[1];
	v[1] = x[7] + -9.;
	slay05h_pd[10] = v[1] * v[1];
	slay05h_pd[11] = v[1] + v[1];
	v[1] = 240. * slay05h_pd[10];
	v[0] += v[1];
	v[1] = x[3] + -3.;
	slay05h_pd[12] = v[1] * v[1];
	slay05h_pd[13] = v[1] + v[1];
	v[1] = 70. * slay05h_pd[12];
	v[0] += v[1];
	v[1] = x[8] + -3.;
	slay05h_pd[14] = v[1] * v[1];
	slay05h_pd[15] = v[1] + v[1];
	v[1] = 70. * slay05h_pd[14];
	v[0] += v[1];
	v[1] = x[4] + -20.;
	slay05h_pd[16] = v[1] * v[1];
	slay05h_pd[17] = v[1] + v[1];
	v[1] = 165. * slay05h_pd[16];
	v[0] += v[1];
	v[1] = x[9] + -17.;
	slay05h_pd[18] = v[1] * v[1];
	slay05h_pd[19] = v[1] + v[1];
	v[1] = 165. * slay05h_pd[18];
	v[0] += v[1];
	rv = v[0] + 300.*x[170];
	rv += 240.*x[171];
	rv += 210.*x[172];
	...
	if (wantfg & 2) {
	dv[0] = 165.*slay05h_pd[19];
	g[9] = dv[0];
	dv[1] = 165.*slay05h_pd[17];
	g[4] = dv[1];
	dv[2] = 70.*slay05h_pd[15];
	g[8] = dv[2];
	dv[3] = 70.*slay05h_pd[13];
	g[3] = dv[3];
	dv[4] = 240.*slay05h_pd[11];
	g[7] = dv[4];
	dv[5] = 240.*slay05h_pd[9];
	g[2] = dv[5];
	dv[6] = 390.*slay05h_pd[7];
	g[6] = dv[6];
	dv[7] = 390.*slay05h_pd[5];
	g[1] = dv[7];
	dv[8] = 150.*slay05h_pd[3];
	g[5] = dv[8];
	dv[9] = 150.*slay05h_pd[1];
	g[0] = dv[9];
	g[170] = 300.;
	g[171] = 240.;
	g[172] = 210.;
 ...
 void
slay05h_ceval_(fint *needfg, real *x, real *c, real *J)
{	real t1;
	fint wantfg = *needfg;
	if (slay05h_xcheck(x) && wantfg == 2)
		wantfg = 3;
