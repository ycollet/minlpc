...
extern "C" {
 ...
 void zerdiv_(real *);
 fint fo7_2_auxcom_[1] = { 14 /* nlc */ };
 fint fo7_2_funcom_[977] = {
	114 /* nvar */,
	1 /* nobj */,
	211 /* ncon */,
	856 /* nzc */,
 ...
 real fo7_2_boundc_[1+228+422] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		1.7889,
		8.54,
		1.7889,
 ...
 static real fo7_2_pd[14];
static real fo7_2_old_x[114];
static int fo7_2_xkind = -1;

 static int
fo7_2_xcheck(real *x)
{
	real *x1 = fo7_2_old_x, *xe = x + 114;
	errno = 0;
	if (fo7_2_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
fo7_2_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (fo7_2_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
fo7_2_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
