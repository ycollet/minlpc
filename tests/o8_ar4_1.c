...
extern "C" {
 ...
 void zerdiv_(real *);
 fint o8_ar4_1_auxcom_[1] = { 16 /* nlc */ };
 fint o8_ar4_1_funcom_[1517] = {
	144 /* nvar */,
	1 /* nobj */,
	347 /* ncon */,
	1366 /* nzc */,
 ...
 real o8_ar4_1_boundc_[1+288+694] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.,
		8.,
		2.,
 ...
 static real o8_ar4_1_pd[16];
static real o8_ar4_1_old_x[144];
static int o8_ar4_1_xkind = -1;

 static int
o8_ar4_1_xcheck(real *x)
{
	real *x1 = o8_ar4_1_old_x, *xe = x + 144;
	errno = 0;
	if (o8_ar4_1_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
o8_ar4_1_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (o8_ar4_1_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
o8_ar4_1_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
  ...
  /***  constraint 347  ***/
   ...
   /*** derivatives for constraint 11 ***/
	...
	J[270] = o8_ar4_1_pd[10];
	J[297] = -1.;

   /*** derivatives for constraint 12 ***/

	J[298] = o8_ar4_1_pd[11];
	J[271] = -1.;

   /*** derivatives for constraint 13 ***/

	J[324] = o8_ar4_1_pd[12];
	J[351] = -1.;

   /*** derivatives for constraint 14 ***/

	J[352] = o8_ar4_1_pd[13];
	J[325] = -1.;

   /*** derivatives for constraint 15 ***/

	J[378] = o8_ar4_1_pd[14];
	J[405] = -1.;

   /*** derivatives for constraint 16 ***/

	J[406] = o8_ar4_1_pd[15];
	J[379] = -1.;
