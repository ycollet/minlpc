...
extern "C" {
 ...
 void zerdiv_(real *);
 fint fo8_ar3_1_auxcom_[1] = { 16 /* nlc */ };
 fint fo8_ar3_1_funcom_[1517] = {
	144 /* nvar */,
	1 /* nobj */,
	347 /* ncon */,
	1366 /* nzc */,
 ...
 real fo8_ar3_1_boundc_[1+288+694] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.3094,
		6.9282,
		2.3094,
 ...
 static real fo8_ar3_1_pd[16];
static real fo8_ar3_1_old_x[144];
static int fo8_ar3_1_xkind = -1;

 static int
fo8_ar3_1_xcheck(real *x)
{
	real *x1 = fo8_ar3_1_old_x, *xe = x + 144;
	errno = 0;
	if (fo8_ar3_1_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
				return 0;
		--x, --x1;
 ...
 real
fo8_ar3_1_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (fo8_ar3_1_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
fo8_ar3_1_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
  ...
  /***  constraint 347  ***/
   ...
   /*** derivatives for constraint 5 ***/
	...
	J[108] = fo8_ar3_1_pd[4];
	J[135] = -1.;

   /*** derivatives for constraint 6 ***/

	J[136] = fo8_ar3_1_pd[5];
	J[109] = -1.;

   /*** derivatives for constraint 7 ***/

	J[162] = fo8_ar3_1_pd[6];
	J[189] = -1.;

   /*** derivatives for constraint 8 ***/

	J[190] = fo8_ar3_1_pd[7];
	J[163] = -1.;

   /*** derivatives for constraint 9 ***/

	J[216] = fo8_ar3_1_pd[8];
	J[243] = -1.;

   /*** derivatives for constraint 10 ***/

	J[244] = fo8_ar3_1_pd[9];
	J[217] = -1.;

   /*** derivatives for constraint 11 ***/

	J[270] = fo8_ar3_1_pd[10];
	J[297] = -1.;

   /*** derivatives for constraint 12 ***/

	J[298] = fo8_ar3_1_pd[11];
	J[271] = -1.;

   /*** derivatives for constraint 13 ***/

	J[324] = fo8_ar3_1_pd[12];
	J[351] = -1.;

   /*** derivatives for constraint 14 ***/

	J[352] = fo8_ar3_1_pd[13];
	J[325] = -1.;

   /*** derivatives for constraint 15 ***/

	J[378] = fo8_ar3_1_pd[14];
	J[405] = -1.;

   /*** derivatives for constraint 16 ***/

	J[406] = fo8_ar3_1_pd[15];
	J[379] = -1.;
