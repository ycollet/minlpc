...
extern "C" {
 ...
 void zerdiv_(real *);
 fint o9_ar4_1_auxcom_[1] = { 18 /* nlc */ };
 fint o9_ar4_1_funcom_[1921] = {
	180 /* nvar */,
	1 /* nobj */,
	435 /* ncon */,
	1734 /* nzc */,
 ...
 real o9_ar4_1_boundc_[1+360+870] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.,
		8.,
		2.,
 ...
 static real o9_ar4_1_pd[18];
static real o9_ar4_1_old_x[180];
static int o9_ar4_1_xkind = -1;

 static int
o9_ar4_1_xcheck(real *x)
{
	real *x1 = o9_ar4_1_old_x, *xe = x + 180;
	errno = 0;
	if (o9_ar4_1_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
o9_ar4_1_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (o9_ar4_1_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
o9_ar4_1_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
  ...
  /***  constraint 435  ***/
   ...
   /*** derivatives for constraint 11 ***/
	...
	J[300] = o9_ar4_1_pd[10];
	J[330] = -1.;

   /*** derivatives for constraint 12 ***/

	J[331] = o9_ar4_1_pd[11];
	J[301] = -1.;

   /*** derivatives for constraint 13 ***/

	J[360] = o9_ar4_1_pd[12];
	J[390] = -1.;

   /*** derivatives for constraint 14 ***/

	J[391] = o9_ar4_1_pd[13];
	J[361] = -1.;

   /*** derivatives for constraint 15 ***/

	J[420] = o9_ar4_1_pd[14];
	J[450] = -1.;

   /*** derivatives for constraint 16 ***/

	J[451] = o9_ar4_1_pd[15];
	J[421] = -1.;

   /*** derivatives for constraint 17 ***/

	J[480] = o9_ar4_1_pd[16];
	J[510] = -1.;

   /*** derivatives for constraint 18 ***/

	J[511] = o9_ar4_1_pd[17];
	J[481] = -1.;
