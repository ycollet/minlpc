...
extern "C" {
 ...
 void zerdiv_(real *);
 fint slay04h_auxcom_[1] = { 0 /* nlc */ };
 fint slay04h_funcom_[627] = {
	140 /* nvar */,
	1 /* nobj */,
	174 /* ncon */,
	480 /* nzc */,
 ...
 real slay04h_boundc_[1+280+348] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.5,
		27.5,
		3.5,
 ...
 static real slay04h_pd[16];
static real slay04h_old_x[140];
static int slay04h_xkind = -1;

 static int
slay04h_xcheck(real *x)
{
	real *x1 = slay04h_old_x, *xe = x + 140;
	errno = 0;
	if (slay04h_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
slay04h_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real v[2], dv[8], rv;
	fint wantfg = *needfg;
	if (slay04h_xcheck(x) && wantfg == 2)
		wantfg = 3;
  ...
  /***  objective ***/
	...
	v[0] = x[0] + -4.;
	slay04h_pd[0] = v[0] * v[0];
	slay04h_pd[1] = v[0] + v[0];
	v[0] = 150. * slay04h_pd[0];
	v[1] = x[4] + -10.;
	slay04h_pd[2] = v[1] * v[1];
	slay04h_pd[3] = v[1] + v[1];
	v[1] = 150. * slay04h_pd[2];
	v[0] += v[1];
	v[1] = x[1] + -10.;
	slay04h_pd[4] = v[1] * v[1];
	slay04h_pd[5] = v[1] + v[1];
	v[1] = 390. * slay04h_pd[4];
	v[0] += v[1];
	v[1] = x[5] + -15.;
	slay04h_pd[6] = v[1] * v[1];
	slay04h_pd[7] = v[1] + v[1];
	v[1] = 390. * slay04h_pd[6];
	v[0] += v[1];
	v[1] = x[2] + -7.;
	slay04h_pd[8] = v[1] * v[1];
	slay04h_pd[9] = v[1] + v[1];
	v[1] = 240. * slay04h_pd[8];
	v[0] += v[1];
	v[1] = x[6] + -9.;
	slay04h_pd[10] = v[1] * v[1];
	slay04h_pd[11] = v[1] + v[1];
	v[1] = 240. * slay04h_pd[10];
	v[0] += v[1];
	v[1] = x[3] + -3.;
	slay04h_pd[12] = v[1] * v[1];
	slay04h_pd[13] = v[1] + v[1];
	v[1] = 70. * slay04h_pd[12];
	v[0] += v[1];
	v[1] = x[7] + -3.;
	slay04h_pd[14] = v[1] * v[1];
	slay04h_pd[15] = v[1] + v[1];
	v[1] = 70. * slay04h_pd[14];
	v[0] += v[1];
	rv = v[0] + 300.*x[104];
	rv += 240.*x[105];
	rv += 210.*x[106];
	...
	if (wantfg & 2) {
	dv[0] = 70.*slay04h_pd[15];
	g[7] = dv[0];
	dv[1] = 70.*slay04h_pd[13];
	g[3] = dv[1];
	dv[2] = 240.*slay04h_pd[11];
	g[6] = dv[2];
	dv[3] = 240.*slay04h_pd[9];
	g[2] = dv[3];
	dv[4] = 390.*slay04h_pd[7];
	g[5] = dv[4];
	dv[5] = 390.*slay04h_pd[5];
	g[1] = dv[5];
	dv[6] = 150.*slay04h_pd[3];
	g[4] = dv[6];
	dv[7] = 150.*slay04h_pd[1];
	g[0] = dv[7];
	g[104] = 300.;
	g[105] = 240.;
	g[106] = 210.;
 ...
 void
slay04h_ceval_(fint *needfg, real *x, real *c, real *J)
{	real t1;
	fint wantfg = *needfg;
	if (slay04h_xcheck(x) && wantfg == 2)
		wantfg = 3;
