...
extern "C" {
 ...
 void zerdiv_(real *);
 fint fo9_auxcom_[1] = { 18 /* nlc */ };
 fint fo9_funcom_[1613] = {
	182 /* nvar */,
	1 /* nobj */,
	343 /* ncon */,
	1424 /* nzc */,
 ...
 real fo9_boundc_[1+364+686] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.,
		8.,
		2.,
 ...
 static real fo9_pd[18];
static real fo9_old_x[182];
static int fo9_xkind = -1;

 static int
fo9_xcheck(real *x)
{
	real *x1 = fo9_old_x, *xe = x + 182;
	errno = 0;
	if (fo9_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
fo9_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (fo9_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
fo9_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
