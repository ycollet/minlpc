...
extern "C" {
 ...
 real o7_boundc_[1+228+422] /* Infinity, variable bounds, constraint bounds */ = {
		1.7e308,
		2.,
		8.,
		2.,
 ...
 static real o7_pd[14];
static real o7_old_x[114];
static int o7_xkind = -1;

 static int
o7_xcheck(real *x)
{
	real *x1 = o7_old_x, *xe = x + 114;
	errno = 0;
	if (o7_xkind >= 0) {
		while(*x++ == *x1++)
			if (x == xe)
 ...
 real
o7_feval_(fint *nobj, fint *needfg, real *x, real *g)
{
	real rv;
	fint wantfg = *needfg;
	if (o7_xcheck(x) && wantfg == 2)
		wantfg = 3;
 ...
 void
o7_ceval_(fint *needfg, real *x, real *c, real *J)
{
	real v[1];
	real t1;
	fint wantfg = *needfg;
